...
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
      <h3><?php echo e(__('Bienvenue sur la page de connexion')); ?> </h3>
    </div>
      ...
      <form class="form" method="POST" action="<?php echo e(route('login')); ?>"> <!---->
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center">
            <h4 class="card-title"><strong><?php echo e(__('Connexion')); ?></strong></h4>
          ...
          <p class="card-description text-center"><?php echo e(__('Merci de nous avoir fait confiance ')); ?> <!-- <strong>admin@material.com</strong> <?php echo e(__(' and the password ')); ?><strong>secret</strong> </p> -->
            ...
            <div class="bmd-form-group<?php echo e($errors->has('password') ? ' has-danger' : ''); ?> mt-3">
              <div class="input-group">
                ...
                <input type="password" name="password" id="password" class="form-control" placeholder="<?php echo e(__('Password...')); ?>" value="<?php echo e(old('password')); ?>" required>
              </div>
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                <input class="form-check-input" type="checkbox" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>> <?php echo e(__('Se rappeler')); ?>
...
<?php echo $__env->make('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Election')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\template\resources\views/auth/login.blade.php ENDPATH**/ ?>