        ...
        <?php if(auth()->guard()->check()): ?>
            <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="wrapper ">
                           <div class="sidebar" data-color="azure" data-background-color="black" data-image="<?php echo e(asset('material')); ?>/img/sidebar-1.jpg">
                       ...
                       <!--     Tip 1: You can change the color of the sidebar using: data-color="purple | azure | green | orange | danger"
                           ...
                           --> 
                            ...
                            <div class="sidebar-wrapper">
                                <ul class="nav">
                                <li class="nav-item<?php echo e($activePage == 'vote' ? ' active' : ''); ?>">
                                    <a class="nav-link" href="<?php echo e(route('votes_form')); ?>">
                                    <i class="material-icons"></i>
                                        <p><?php echo e(__('Vote')); ?></p>
                                    </a>
                                </li>
                                <li class="nav-item<?php echo e($activePage == 'votefermer' ? ' active' : ''); ?>">
                                    <a class="nav-link" href="<?php echo e(route('votefermer')); ?>">
                                    <i class="material-icons"></i>
                                        <p><?php echo e(__('Clôture de Vote')); ?></p>
                                    </a>
                                </li>
                                </ul>
                            </div>
                      ...
                      <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                            <a class="dropdown-item" href="<?php echo e(route('profile.editelecteur')); ?>"><?php echo e(__('Profil')); ?></a>
                            <!--a class="dropdown-item" href="#"><?php echo e(__('Settings')); ?></a-->
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><?php echo e(__('Se déconnecter')); ?></a>
                          </div>
                        </li>
                      </ul>
                    </div>
          ...
          <div class="dropdown show-dropdown">
            ...
            <ul class="dropdown-menu">
             ...
             <!-- <li class="button-container">
              ...
              <li class="header-title">Merci pour votre confiance</li>
            </ul>
          </div>
        </div>
        <?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\template\resources\views/layouts/appelecteur.blade.php ENDPATH**/ ?>