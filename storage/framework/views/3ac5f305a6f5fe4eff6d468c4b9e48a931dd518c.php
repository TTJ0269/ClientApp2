       ...
       <!-- <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
            <a class="dropdown-item" href="<?php echo e(route('profile.edit')); ?>"><?php echo e(__('Profil')); ?></a>
...
<?php /**PATH C:\xampp\htdocs\laravel\template\resources\views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>